...
import ai.mcts.naivemcts.NaiveMCTS2;
 ...
 * @author albertouri
 */
public class BS4_NaiveMCTS extends NaiveMCTS2 implements AIWithBelieveState {
    ...
    public BS4_NaiveMCTS(UnitTypeTable utt) {
        super(utt);
    }

    public BS4_NaiveMCTS(int available_time, int max_playouts, int lookahead, int max_depth,
    ...
    @Override
    public AI clone() {
        return new BS4_NaiveMCTS(TIME_BUDGET, ITERATIONS_BUDGET, MAXSIMULATIONTIME, MAX_TREE_DEPTH, epsilon_l, discount_l, epsilon_g, discount_g, epsilon_0, discount_0, playoutPolicy, ef, forceExplorationOfNonSampledActions);
    }
