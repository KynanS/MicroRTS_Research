...
import ai.mcts.naivemcts.NaiveMCTS3;
 ...
 * @author albertouri
 */
public class BS5_NaiveMCTS extends NaiveMCTS3 implements AIWithBelieveState {
    ...
    public BS5_NaiveMCTS(UnitTypeTable utt) {
        super(utt);
    }

    public BS5_NaiveMCTS(int available_time, int max_playouts, int lookahead, int max_depth,
    ...
    @Override
    public AI clone() {
        return new BS5_NaiveMCTS(TIME_BUDGET, ITERATIONS_BUDGET, MAXSIMULATIONTIME, MAX_TREE_DEPTH, epsilon_l, discount_l, epsilon_g, discount_g, epsilon_0, discount_0, playoutPolicy, ef, forceExplorationOfNonSampledActions);
    }
