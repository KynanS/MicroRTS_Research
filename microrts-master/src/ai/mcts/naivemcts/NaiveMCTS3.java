 ...
 * @author santi
 */
public class NaiveMCTS3 extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public NaiveMCTS3(UnitTypeTable utt) {
        this(-1,1000,50,10,
             0.3f, 0.0f, 0.4f,
             new RandomBiasedAI(),
    ...
    public NaiveMCTS3(int available_time, int max_playouts, int lookahead, int max_depth, 
    ...
    public NaiveMCTS3(int available_time, int max_playouts, int lookahead, int max_depth, float e_l, float e_g, float e_0, AI policy, EvaluationFunction a_ef, boolean fensa) {
        super(available_time, max_playouts);
        MAXSIMULATIONTIME = lookahead;
        playoutPolicy = policy;
        MAX_TREE_DEPTH = max_depth;
    ...
    public NaiveMCTS3(int available_time, int max_playouts, int lookahead, int max_depth, float e_l, float e_g, float e_0, int a_global_strategy, AI policy, EvaluationFunction a_ef, boolean fensa) {
        super(available_time, max_playouts);
        MAXSIMULATIONTIME = lookahead;
        playoutPolicy = policy;
        MAX_TREE_DEPTH = max_depth;
...
//            if (best == null || (child.accum_evaluation/child.visit_count)>(best.accum_evaluation/best.visit_count)) {
    ...
    public List<ParameterSpecification> getParameters() {
        ...
        parameters.add(new ParameterSpecification("TimeBudget",int.class,-1));
        parameters.add(new ParameterSpecification("IterationsBudget",int.class,250));
        parameters.add(new ParameterSpecification("PlayoutLookahead",int.class,10));
        parameters.add(new ParameterSpecification("MaxTreeDepth",int.class,2));
