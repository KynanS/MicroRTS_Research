...
public class FEStatePane extends JPanel {
    ...
    /**
     * Killer Base Stats to be altered
     */
    public static int killerCost = 2;

    public static int killerHP = 3;

    public static int killerMinDamage = 2;

    public static int killerMaxDamage = 2;

    public static int killerAttackRange = 4;

    public static int killerProduceTime = 100;

    public static int killerMoveTime = 10;

    public static int killerAttackTime = 5;
            ...
            // Start of Games
            {
                ...
                b.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        for (int i = 0; i < Integer.parseInt(numberOfGames.getText()); i++){
                            textArea.append("Playing Game #" + Integer.toString(i + 1) + "\n");   
...
//                                                System.out.println(gs);
                                            ...
                                            //check to see if a Killer was made
                                            if (gs.getPhysicalGameState().killerMade() && !wasKillerMade){
                                                textArea.append("Killer was made");
                                                wasKillerMade = true;
                                            }
                                    ...
                                    if (gameover){
                                        if (gs.getPhysicalGameState().winner() == 0){
                                            textArea.append("Player 0 wins!\n");
                                        }
                                        else if (gs.getPhysicalGameState().winner() == 1){
                                            textArea.append("Player 1 wins!\n");
                                        }
                                        else{
